...
const HikingListRecord = ({ userNo }) => {
  ...
  useEffect(() => {
    userNo = 1;
    axios.post(`https://www.dearmysanta.site/hikingGuide/react/getHikingListRecord/${userNo}`)
      .then(response => {
  ...
  const handleDeleteSelected = () => {
    axios.post('https://www.dearmysanta.site/hikingGuide/react/deleteHikingRecord', selectedItems)
      .then(() => {
